...
import com.example.music_catalogue.factory.MusicWindowFactory;
import com.example.music_catalogue.repository.AuthRepository;
    ...
    private void handleLogin(ActionEvent event) {
        ...
        try {
            if (authRepository.authenticate(username, password)) {
                ...
                Scene scene = MusicWindowFactory.createScene();
                stage.setTitle("My Music Catalogue");
